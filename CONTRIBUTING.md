...
If you are proposing a new feature, make sure to [open an issue](https://github.com/damienbutt/arch-base/issues/new/choose) to make sure it is inline with the project goals.
